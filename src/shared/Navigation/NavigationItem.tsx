...
const NavigationItem: FC<NavigationItemWithRouterProps> = ({ menuItem }) => {
	...
	const renderMainItem = (item: NavItemType) => {
		return (
			<Link
				rel="noopener noreferrer"
				className="inline-flex items-center rounded-full px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-neutral-100 hover:text-neutral-900 dark:text-black dark:hover:bg-neutral-800 dark:hover:text-neutral-200 xl:px-5 xl:text-base"
				href={item.href || '/'}
			>
				{item.name}
				{item.type && (
